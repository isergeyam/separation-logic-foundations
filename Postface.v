(** * Postface: Conclusion and Perspectives *)
...
(** Ideas of Separation Logic have had significant influence on the field
    ...
    - The tool "Veriable C" tool, from the VST project, targets the verification
      of C code, using interactive Coq proofs based on Separation Logic.
